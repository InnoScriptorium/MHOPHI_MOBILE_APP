...
const buttonContainersData = [
    ...
    },
    {
        ...
        description: "Operations that stacks alternate layers of fins and tubes and attaching",
        workcardsNo: "960",
    },
    {
        title: "FORMING",
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                ...
                <View style={styles.assignmentContainer}>
                    ...
                    <Text style={styles.textContainer1}>To record process parameters</Text>
                </View>
                <View style={styles.separator} />
                ...
                {buttonContainersData.map((data, index) => (
                    <View style={styles.buttonContainer} key={index}>
                        <View style={styles.button}>
                            ...
                            <Text style={styles.buttonText}>Workcards No:{data.workcardsNo}</Text>
                            <View style={styles.buttonsWrapper}>
                                <TouchableOpacity onPress={handleLoginPress1} style={styles.viewWorkcardButton}>
                                    <Text style={{ color: 'white' }}>View Workcard List</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={handleLoginPress} style={styles.scanQRButton}>
